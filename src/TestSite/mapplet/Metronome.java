...
public class Metronome extends PApplet {
...
//removed class declaration 
  ...
  int dgray = color(41,39,39);
  int lgray = color(116,116,135); //227
  int gray = color(87,87, 102);
  int white = color(256);
  int aquamarine = color(127,255,212);
  int viored = color(89,22,23);
  int fred = color(158,76,77);
  int pillRed = color(255,0,0);
  int brue = color(0,0,255);
...
//  
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "Metronome" });
  }
}
